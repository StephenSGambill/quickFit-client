...
export const MembersPage = () => {
    ...
    return (
        <div className="bg-slate-400 min-h-screen rounded">
            <div className="m-5 text-3xl font-bold text-center p-8">Members Page</div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-4">
                {members.map((member) => (
                    <div key={member.id} className="bg-white rounded shadow-md p-4">
