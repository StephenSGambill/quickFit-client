...
export const getExercises = () => {
    return fetch(`https://king-prawn-app-4ozdj.ondigitalocean.app/exercises`, {
        headers: {
...
export const getExercisesByGroup = (id) => {
    return fetch(`https://king-prawn-app-4ozdj.ondigitalocean.app/workoutgroups/${id}`, {
        headers: {
            "Authorization": `Token ${getToken()}`
        }
    })
...
export const deleteExercise = (id) => {
    return fetch(`https://king-prawn-app-4ozdj.ondigitalocean.app/exercises/${id}`, {
        method: "DELETE",
        headers: {
            "Authorization": `Token ${getToken()}`
        }
